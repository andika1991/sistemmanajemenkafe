...
<body>
    ...
    <div class="content" id="content">
        ...
        <main>
        <h2>Tambah  Staff/Karyawan</h2>
<form action="prosestambahkaryawan.php" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="posisi" name="posisi" required>
            ...
            <option>Koki</option>
            <option>Karyawan Kebersihan</option>
    ...
    <input type="submit" class="btn btn-primary" value="Tambah Karyawan"></input>
</form>
