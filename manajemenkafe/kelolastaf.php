...
<body>
    ...
    <div class="content" id="content">
        ...
        <main>
            ...
            <div class="mb-3">
                <a href="tambahdatakaryawan.php" class="btn btn-primary">Tambah Data</a>
            </div>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td>
                                <a href="editkaryawan.php?id=<?php echo $row['staff_id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" onclick="showConfirmation(<?php echo $row['staff_id']; ?>)">Delete</a>
...
function deleteItem() {
  window.location.href = 'hapus_staf.php?id=' + idToDelete;
}
</script>
